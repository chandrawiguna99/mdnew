...
case 'donasi': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7f4c4c065091f30a8ed96.jpg' }, caption: `Silahkan Scan Kode QR Diatas Untuk Donasi` }, { quoted: m })
            }
            break
case 'gopay': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7f4c4c065091f30a8ed96.jpg' }, caption: `GOPAY` }, { quoted: m })
            }
            break
case 'dana': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7f4c4c065091f30a8ed96.jpg' }, caption: `DANA` }, { quoted: m })
            }
            break
case 'qris': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7f4c4c065091f30a8ed96.jpg' }, caption: `QRIS ALL PAYMENT` }, { quoted: m })
            }
            break
...
let btn = [{
            ...
            break
case 'sewabot': {
	anu = `╭──「 *_SEWA BOT BY ChandraPedia_* 」
│❏ ➪ _1 MINGGU : 1K_
│❏ ➪ _1 BULAN : 5K_
│❏ ➪ _PERMANEN : 10k_
╰────
...
╰──── 
╭─[ *MINAT CHAT📌*]
│❏ ➪ 🪀 _wa.me/6285861009691?text=SEWA+BOT_
╰────
╭─[ *PAYMENT💰*]
│❏ ➪ _GOPAY_
│❏ ➪ _DANA_
  ...
  case 'menu': {
	anu = `Hai Kak ${pushname}\n\nSaya Adalah NelzBotz, Bot Ini Memakai Program Multi Device Beta Dari WhatsApp.\n\nJadi Jika Kamu Menemukan Bug Atau Kesalahan Silahkan Laporkan Kepada Owner Agar Segera Di Perbaiki.\n\nTerima Kasih🙏`
              let btn = [{
                        ...
                        hisoka.send5ButImg(m.chat, anu, '© ChandraPedia', global.thumb, btn)
                     }
            break
            case 'command':{
